package kz.kairliyev.loginscreen_android.data.preferences
...
class AppPreferenceHelper @Inject constructor(context: Context,
    ...
    override fun getCurrentUserName(): String = mPrefs.getString(PREF_KEY_CURRENT_USER_NAME, "AAA")!!

    override fun setCurrentUserName(userName: String?) = mPrefs.edit { putString(PREF_KEY_CURRENT_USER_NAME, userName) }

    override fun getCurrentUserEmail(): String = mPrefs.getString(PREF_KEY_CURRENT_USER_EMAIL, "aaa@gmail.com")!!
